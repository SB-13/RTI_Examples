...
java -Djava.ext.dirs=$NDDSHOME/lib/java ShapeTypePublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/lib/java ShapeTypeSubscriber <domain_id>        
*/
...
public class ShapeTypePublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            ShapeType instance = new ShapeType();
            ...
            ++count) {
                System.out.println("Writing ShapeType, count " + count);
